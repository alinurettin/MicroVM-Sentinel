// MicroVM-Sentinel - Production HTTP Server & OpenMetrics Exporter
...
const PORT = parseInt(process.env.PORT, 10) || 6049;
...
if (require.main === module) {
  startServer(PORT, () => {
    console.log('⚡ MicroVM-Sentinel active at http://localhost:' + PORT);
  });
}
